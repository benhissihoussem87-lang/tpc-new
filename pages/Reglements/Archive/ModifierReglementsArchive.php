      ...
      <div class="card-body">
		  ...
		  <div class="modal-body row">
			...
			<div class="mb-3 col-2" >
				...
				<option <?php if($detailFacture['reglement']=='oui'){ echo 'selected';}?>>Oui</option>
				<option <?php if($detailFacture['reglement']=='non'){ echo 'selected';}?>>Non</option>
				<option <?php if($detailFacture['reglement']=='Avance'){ echo 'selected';}?>>Avance</option>
				</select>
